...
from ml3d.datasets import WhuRail, ExpressRail, SNCFRail
...
if __name__ == '__main__':
    ...
    cfg_file = f"dataset/{datasetName}/config_RandLA.yaml"
    ...
    if run_mode == "train":
        ...
        model = RandLANet(**cfg.model)  # 创建模型 无需.cuda()，先放在cpu，semantic_segmentation.py会切换到gpu
    ...
    if run_mode == "test":
        ...
        model = RandLANet(test_ckpt_path=test_ckpt_path, **cfg.model)
