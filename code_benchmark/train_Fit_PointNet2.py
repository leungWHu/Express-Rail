...
from ml3d.torch import PointNet2, SemanticSegmentation
...
if __name__ == '__main__':
    ...
    cfg_file = f"dataset/{datasetName}/config_PointNet2.yaml"
    ...
    if run_mode == "train":
        ...
        model = PointNet2(**cfg.model)  # 创建模型 无需.cuda()，先放在cpu，semantic_segmentation.py会切换到gpu
    ...
    if run_mode == "test":
        ...
        model = PointNet2(test_ckpt_path=test_ckpt_path, **cfg.model)
