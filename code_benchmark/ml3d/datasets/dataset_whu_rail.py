...
class WhuRail(BaseDataset):
    ...
    def get_split(self, split):
        ...
        """
        return WhuRailSplit(self, split=split)
...
class WhuRailSplit(BaseDatasetSplit):
...
DATASET._register_module(WhuRail)
