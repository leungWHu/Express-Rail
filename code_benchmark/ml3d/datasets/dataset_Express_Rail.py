...
class ExpressRail(BaseDataset):
    ...
    def get_split(self, split):
        ...
        """
        return ExpressRailSplit(self, split=split)
    ...
    def get_split_list(self, split):
        ...
        if split in ['train', 'training']:
            ...
            print(f" > > > Debug :")
            seq_list = ["L02-label-2.las", "L04-label-2.las"]
...
class ExpressRailSplit(BaseDatasetSplit):
...
DATASET._register_module(ExpressRail)
